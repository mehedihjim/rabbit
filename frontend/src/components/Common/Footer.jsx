    ...
    <footer className="border-t border-gray-200 py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div className="">
          ...
          <form className="flex">
            ...
            <button
              type="submit"
              className="cursor-pointer bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-900 transition-all"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="container mx-auto mt-12 lg:px-0 border-t border-gray-300 pt-6 ">
        <p className="text-gray-500 text-sm tracking-tighter text-center">
          ©2025, <a href="https://github.com/mehedihjim">MH Jim</a>. All Rights
          Reserved.{" "}
        </p>
      </div>
    </footer>
