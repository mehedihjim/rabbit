            ...
            <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <div className="p-4">
                    ...
                    <nav className='space-y-4'>
                        ...
                        <Link to='/' className='block text-gray-600 hover:text-black' onClick={toggleNavDrawer}>Top Wear</Link>
                        <Link to='/' className='block text-gray-600 hover:text-black' onClick={toggleNavDrawer}>Bottom Wear</Link>
                    </nav>
                </div>
            </div>
        </>
