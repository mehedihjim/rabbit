    ...
    <section className="relative">
      ...
      <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
        <div className="text-center text-white p-6 ">
          ...
          <p className="text-sm tracking-tighter md:text-lg mb-7">
            Explore our new Fashion Collection with Fast worldwide shipping
          </p>
          <Link
            to="/collections/all"
            className="text-xl font-light font-rabbit-saadhu px-4 py-2 border border-white hover:bg-white hover:text-black transition"
          >
            Explore Our Shop~
          </Link>
        </div>
